package work.iruby.leetcode.medium;//给你一个整数数组 cost 和一个整数 target 。请你返回满足如下规则可以得到的 最大 整数：
//
// 
...
class Solution1449 {
    static class Test {
        public static void main(String[] args) {
            Solution1449 test = new Solution1449();
            long start = System.currentTimeMillis();
            System.out.println(test.largestNumber(new int[]{7, 6, 5, 5, 5, 6, 8, 7, 8}, 12));
